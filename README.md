...
- 🔗 **Wallet Connection** via Reown AppKit (Base chain)
- 🌈 **Multi-Chain Support** - Analyzes activity across Ethereum + Base (expandable to Optimism, Zora, etc.)
- 🤖 **AI-Powered Horoscopes** generated by GPT-4o-mini with professional analysis
- 📊 **Real Transaction Data** - Fetches actual lifetime transaction counts
- 🎨 **Beautiful UI** with stats grid, gradient cards, and modern design
- ⚡ **Real-time Data** from Covalent API (multi-chain) or BaseScan (Base only)
- 🎭 **Onchain Zodiac Signs** based on your degen score
- 💫 **Smooth Animations** with Framer Motion
- 🏆 **Most Active Chain** detection and display
- 🎨 **NFT Minting** - Mint horoscopes as on-chain NFTs (0.001 ETH)
- 🖼️ **On-Chain SVGs** - Fully on-chain metadata, no IPFS needed!
...
# Optional: NFT Contract Address (for minting feature)
...
│  ├─ /api
│  │  └─ /generate-horoscope
│  │     └─ route.ts          # GPT-4 horoscope generation API
...
│  ├─ ConnectButton.tsx       # Reown wallet connect button
│  ├─ HoroscopeCard.tsx       # Horoscope display card
│  └─ LoadingState.tsx        # Loading animation
├─ /lib
│  ├─ config.ts               # Reown AppKit configuration
│  ├─ fetchWalletData.ts      # BaseScan/Covalent integration
│  ├─ gpt.ts                  # OpenAI API calls
│  ├─ zodiacLogic.ts          # Onchain zodiac mapping
...
## 🌙 Onchain Zodiac Signs

- 🔥 **DegenerateAries** (80-100): The eternal degen
- 💎 **DiamondTaurus** (65-79): Diamond hands incarnate
- 🌙 **MoonboyGemini** (50-64): Airdrop chaser
- 🦀 **CrabCancer** (35-49): Sideways trader
- 🦁 **LionLeo** (20-34): Proud hodler
- 📊 **ChartistVirgo** (10-19): Analysis paralysis
- 🐌 **SlowpokeLibra** (0-9): Just getting started
...
You can now mint horoscopes as NFTs on Base!

**Features:**
- ✅ 100% on-chain metadata (no IPFS!)
- ✅ Dynamic SVG images
- ✅ OpenSea compatible
- ✅ 0.001 ETH per mint (~$2)
- ✅ Instant minting

**Setup:**
1. Deploy the smart contract (`contracts/OnchainHoroscope.sol`)
2. Add contract address to `.env.local`
3. Users can mint their horoscopes!

See `MINTING_SETUP.md` for complete deployment guide.

## 🌟 Future Features

- [x] Mint horoscope as NFT on Base ✅ **DONE!**
- [ ] Share directly to Farcaster
- [ ] Historical horoscope tracking
- [ ] Compatibility checker (compare two wallets)
- [ ] Horoscope leaderboard
- [ ] Trait-based NFT rarity
- [ ] Animated SVG NFTs

---

**For entertainment purposes only. DYOR, anon.** 🌙✨
